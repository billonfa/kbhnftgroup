...
<head>
    ...
    <title>KBH GROUP - XỔ SỐ CASINO</title>
    <link href="dist/css/font-face.css" rel="stylesheet" />
    <link rel="stylesheet" href="styles.css">
    <link href="dist/css/data-aos.css" rel="stylesheet">
    <script src="dist/js/feather-icon.min.js"></script>
    <style>
        :root {
        ...
        *:after {
        ...
        @keyframes hienRoDan {
            ...
            /* Tỷ lệ mờ bằng 100% (hoàn toàn hiển thị) */
        }

        /* Áp dụng animation cho thẻ div có class là "messages" */
        .invisible {
            animation-name: hienRoDan;
            /* Sử dụng keyframes đã định nghĩa */
            animation-duration: 1s;
            /* Thời gian thực hiện animation là 1 giây */
        }
    </style>
</head>
...
<body>
    ...
    <section class="msger">
        <header class="msger-header">
            <div class="msger-send-btn_b">
                <div>KBH GROUP - XỔ SỐ CASINO </div>
        ...
        <div class="msger-inputarea">
            <a href="https://t.me/thuytien06" target="_blank" class="msger-send-btn_b" style="text-align:center">Click để Nhắn tin vào Nhóm Vip Miễn Phí</a>
        </div>
    </section>
    ...
    <script src="dist/js/pusher.min.js"></script>
    <script src="dist/js/data-aos.js"></script>
    <script src="dist/js/event8.js"></script>
    <script>
        feather.replace()
    </script>
</body>