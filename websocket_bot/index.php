...
$token = '6178304216:AAExTGcExwHzNPhTU0ZhIGsGly5rrdseSfc';
...
// https://api.telegram.org/bot6142271320:AAHCNtgWw-ok40G1xkzyXVmgJJk2yFuXDtM/setWebhook?url=https://kbh.nftgroupvn.com/websocket_bot/index.php

// https://api.telegram.org/bot6178304216:AAExTGcExwHzNPhTU0ZhIGsGly5rrdseSfc/setWebhook?url=https://kbh.nftgroupvn.com/websocket_bot/index.php bot chính
// https://api.telegram.org/bot6142271320:AAHCNtgWw-ok40G1xkzyXVmgJJk2yFuXDtM/getUpdates
// Pusher
...
function event_websocket ($update_data) {
    ...
    try {
        ...
        $sql = "INSERT INTO message_from_bot (name, content, avatar_url, photo, forward_from, gif, sticker) VALUES (:name, :content, :avatar, :photo, :forward_from, :gif, :sticker)";
        ...
        $conn = null;
        // send_message($update_data['message']['chat']['id'], $message_photo);
    ...
    $pusher = new Pusher\Pusher(
        "95ac518379b04ba2b542",
        "8386be2f32e2c6e1fa37",
        "1618881",
        array('cluster' => 'mt1')
    );
    
    $pusher->trigger('my-channel', 'message_bot_telegram', array(
