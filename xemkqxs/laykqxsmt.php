<?php
function laydataxsmt () {
    include 'connect.php';
    $date = getdate();
    if($date['hours'] < 17 && $date['minutes'] < 55) $date['mday'] -= 1;
    ...
    $html = file_get_html('https://www.minhngoc.net.vn/xo-so-mien-trung.html');
    $kqxs = $html->find('.box_kqxs .content', 0);
    ...
    foreach($data as $key_data => $value_data) {
        ...
        try {
            ...
            $conn->exec("INSERT INTO data_xskt_mt (name_dai, g8, g7, g6, g5, g4, g3, g2, g1, gdb, mien, created_at) VALUES ('$name_dai', '$g8', '$g7', '$g6', '$g5', '$g4', '$g3', '$g2', '$g1', '$gdb' , '$mien', '$created_at')");
            // cam kết giao dịch
            $conn->commit();
